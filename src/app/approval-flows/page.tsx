...
export default function ApprovalFlowsPage() {
  ...
  const [embedUrl, setEmbedUrl] = useState<string>(APPROVAL_FLOWS_EMBED_URL);
  ...
  useEffect(() => {
    try {
      const url = getEmbedUrlWithDarkMode(APPROVAL_FLOWS_EMBED_URL, isDarkMode);
      setEmbedUrl(url);
    } catch (error) {
    ...
    <div className="container py-10">
      ...
      >
        <div className="mx-auto max-w-4xl">
          <div className="mb-6">
            <h1 className="mb-2 text-3xl font-bold">Approval Flows</h1>
            <p className="text-muted-foreground">
              Process and manage approval requests for elevated permissions and resource access.
            </p>
          </div>
          ...
          <AuthenticationStep 
            ...
            description="Connect to enable approval flows functionality"
          />

          {/* Step 4: Preview */}
          <PreviewStep
            stepNumber={4}
            title="Approval Flows Element"
            elementId="approval-flows"
            description="Manage and process approval requests for elevated permissions and resource access."
            embedUrl={embedUrl}
            envId={environmentId}
            tenantId={tenantId}
            userToken={userJwt}
